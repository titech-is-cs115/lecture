...
1. Scalaのプログラム（モジュール，パッケージ，trait，多相性，可変変数，代入）: [解説](lx05)
1. 変数を用いたプログラムのデザインレシピ: [スライド](https://github.com/titech-is-cs115/lecture/blob/develop/06.pdf), プログラム集 (`https://github.com/titech-is-cs115/lx06)
1. 状態変化を伴うプログラミング
1. 複合的な構造を持つデータの扱い
1. オブジェクトとクラス
1. 例外処理
